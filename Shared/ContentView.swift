...
let roles = ["square.and.arrow.up", "square.and.arrow.up.on.square.fill", "pencil.circle", "pencil.and.ellipsis.rectangle", "trash.circle"]
    ...
    var body: some View {
        VStack {
            ...
            BannerView(roles,
                       ...
                       spacing: spacing,
                       headspace: headspace,
                       autoScroll: .active(time)) { name in
//                Color.gray
//                    .frame(height: 300)
